...
return [
	...
	/*
	 * http://api.app/oauth/access_token?grant_type=password&client_id=hoojoo&client_secret=boojoo&username=ryan@vextras.com&password=scooby&redirect_uri=http://google.com
	|--------------------------------------------------------------------------
	| API Vendor
	|--------------------------------------------------------------------------
	|
